...
<html lang="en">
  <head>
    <title>Sobre nós - Dolls & Plush</title>
    <meta charset="utf-8">
       ...
       <div class="container">
		<div class="row">
			<div class="[ col-sm-6 col-md-offset-2 col-md-4 ]">
				<div class="[ info-card ]">
					<img style="width: 100%;" src="css/pics/profile.png"/>
					<div class="[ info-card-details ] animate">
						<div class="[ info-card-header ]">
							<h1> Joel dos Anjos </h1>
						</div>
					</div>
				</div>
			</div>
